...
orientation:
  ...
  y: 0.0
  z: 0.0
  w: 0.0   # ← All zeros! No orientation!
orientation_covariance: [-1.0, 0.0, 0.0, ...]  # -1 means "not provided"
angular_velocity:
  x: -0.0123    # rad/s - we have this!
  y: 0.0045
  z: -0.0012
linear_acceleration:
  x: 0.142      # m/s² - we have this!
  y: -0.087
  z: 9.78       # ← Gravity! Pointing down.
```
...
roll: 0.02
pitch: -0.01
yaw: 0.15       # ← Starting yaw

# After 360° rotation and return
roll: 0.02      # ← Roll is fine!
pitch: -0.01    # ← Pitch is fine!
yaw: 0.87       # ← YAW DRIFTED! Should be ~0.15!
```
...
**With the camera sitting perfectly still:**
...
# t = 5 seconds
position: {x: 0.12, y: -0.08, z: 0.03}  # ← Already drifting!

# t = 30 seconds
position: {x: 2.45, y: -1.87, z: 0.94}  # ← METERS of drift!

# t = 60 seconds
position: {x: 8.73, y: -4.21, z: 2.15}  # ← COMPLETELY WRONG!
```
...
# Navigate to:
# More → On-chip Calibration → Calibrate IMU
...
|--------|------------|-----------|-------------|
| X bias | 0.142 m/s² | 0.003 m/s² | 47x better |
| Y bias | 0.087 m/s² | 0.002 m/s² | 43x better |
| Z error | 0.08 m/s² | 0.003 m/s² | 27x better |
