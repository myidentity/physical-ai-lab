...
![[6] Computing the context vector - a weighted sum of Value vectors, where weights come from attention scores. High attention = more influence.](images/chapter-3-context-vectors.png)
...
![[7] Interactive attention visualization - watch how tokens update their representations by attending to relevant neighbors.](images/chapter-3-attention-visualization.png)
