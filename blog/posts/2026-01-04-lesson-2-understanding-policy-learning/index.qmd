...
![[8] The "secret recipe machine" - turn the knobs (latent variables) and the machine produces handwriting that matches those settings.](images/chapter-4-secret-machine.jpg)
