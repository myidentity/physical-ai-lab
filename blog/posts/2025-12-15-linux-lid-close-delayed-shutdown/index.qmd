...
::: {.callout-note}
## Credits
This solution was developed while debugging a frustrating suspend issue on an ASUS laptop with NVIDIA GPU running Ubuntu 24.04. Special thanks to Claude Code for the pair programming session that produced this solution.
:::
